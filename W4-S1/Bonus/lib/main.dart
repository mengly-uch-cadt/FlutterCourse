...
import 'package:weather_app/city_forecast_card.dart';
import 'dart:ui';
import 'package:weather_app/main_card.dart';
import 'package:weather_app/stat/stat.dart';
import 'package:weather_app/table.dart';
                  ...
                  child: AppBar(
                    ...
                    actions: [
                      Padding(
                        ...
                        child: Image.asset("assets/us_flag.png", width: 30),
                      )
                    ],
                  ...
                  children: [
                    ...
                    // const SizedBox(height: 10,),
                     Align(
                      ...
                      child: Lottie.asset(
                        'assets/cute-cat.json', // Replace with your Lottie file path
