            ...
            children: [
              ...
              TableRow(
                children: [
                  ...
                  Center(child: Image.asset("assets/light_rain_at_night.png")),
                  Center(child: Image.asset("assets/lightning.png")),
                  Center(child: Image.asset("assets/rain.png")),
                  Center(child: Image.asset("assets/sleet.png")),
                  Center(child: Image.asset("assets/snow.png")),
                  Center(child: Image.asset("assets/wind.png")),
                ],
              ),
              const TableRow(
                children: [
